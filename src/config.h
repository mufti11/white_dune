...
/* the code using imlib2 (NodeImageTexture3D) is not ready yet, won't compile */
/* #undef HAVE_LIBIMLIB2 */

/* define if you have gles version 2 */
...
#define HAVE_DUNE_VERSION "white_dune 0.99rc1332"
