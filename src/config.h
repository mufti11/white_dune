...
#define HAVE_WWW_BROWSER "/usr/bin/firefox %s &"
...
#define HAVE_VRML_REMOTE_BROWSER "/usr/bin/firefox -remote OpenURL\\(%s\\)"
...
#define HAVE_DUNE_VERSION "white_dune 0.99rc1288"
