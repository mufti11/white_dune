...
#ifndef _NODE_LAYOUT_LAYER_H
#define _NODE_LAYOUT_LAYER_H
...
class NodeLayoutLayer : public Node {
public:
                    NodeLayoutLayer(Scene *scene, Proto *proto);

    virtual const char* getComponentName(void) const { return "Layout"; }
    virtual int     getComponentLevel(void) const { return 1; }
    virtual int     getX3dVersion(void) const { return 2; }
    virtual Node *  copy() { return new NodeLayoutLayer(m_scene, m_proto); }
    ...
    fieldMacros(SFNode, layout,     ProtoLayoutLayer);
    fieldMacros(SFNode, viewport,   ProtoLayoutLayer);
};
