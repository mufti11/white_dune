/*
 * NodeSquadOrientationInterpolator.h
 *
...
public:
                    ProtoSquadOrientationInterpolator(Scene *scene);
    virtual Node   *create(Scene *scene);

    virtual int     getType() const { return X3D_SQUAD_ORIENTATION_INTERPOLATOR; }
...
class NodeSquadOrientationInterpolator : public Node {
public:
                    NodeSquadOrientationInterpolator(Scene *scene, Proto *proto);
