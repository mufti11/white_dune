...
public:
                    ProtoTUIToggleButton(Scene *scene);
    virtual Node   *create(Scene *scene);

    virtual int     getType() const { return COVER_TUI_TOGGLE_BUTTON; }

    FieldIndex state;
};

class NodeTUIToggleButton : public TUIElement {
public:
