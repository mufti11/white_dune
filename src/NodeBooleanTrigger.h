...
public:
                    ProtoBooleanTrigger(Scene *scene);
    virtual Node   *create(Scene *scene);

    virtual int     getType() const { return X3D_BOOLEAN_TRIGGER; }

    virtual bool    isX3dInternalProto(void) { return true; }

    FieldIndex set_triggerTime;
    FieldIndex triggerTrue;
};
