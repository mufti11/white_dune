...
class MyTriEdgeCollapse: public TriEdgeCollapseQuadric< CMeshO, VertexPair , 
                                                        MyTriEdgeCollapse, 
                                                        QHelper> {
                        public:
            typedef  TriEdgeCollapseQuadric< CMeshO, VertexPair, 
                                             MyTriEdgeCollapse, QHelper> TECQ;
            inline MyTriEdgeCollapse(const VertexPair &p, int i, 
                                     BaseParameterClass *pp) :TECQ(p,i,pp){}
};
} // end namespace tri
} // end namepsace vcg
