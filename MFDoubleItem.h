...
#ifndef _MFDOUBLE_ITEM_H
#define _MFDOUBLE_ITEM_H

#include "FieldViewItem.h"

class MFDoubleItem : public MFieldViewItem {
public:
                                MFDoubleItem(FieldView *view);
    ...
    virtual bool                IsTrackable() const;
