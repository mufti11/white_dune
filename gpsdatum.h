...
{
    { "Airy 1830",               6377563.396, 299.3249646 },    // AA (00) Airy1830                          
    { "Airy 1830 Modified",      6377340.189, 299.3249646 },    // AM (01) ModifiedAiry                      
    { "Australian National",     6378160.000, 298.25 },         // AN (02) AustralianNational                
    { "Bessel 1841 (Namibia)",   6377483.865, 299.1528128 },    // BN (03) Bessel1841(Namibia)               
    { "Bessel 1841",             6377397.155, 299.1528128 },    // BR (04) Bessel1841(EthiopiaIndonesia...)  
    { "Clarke 1866",             6378206.400, 294.9786982 },    // CC (05) Clarke1866                        
    { "Clarke 1880",             6378249.145, 293.465 },        // CD (06) Clarke1880                        
    { "Everest (India 1830)",    6377276.345, 300.8017 },       // EA (07) Everest(India1830)                
    { "Everest (Sabah Sarawak)", 6377298.556, 300.8017 },       // EB (08) Everest(Sabah&Sarawak)            
    { "Everest (India 1956)",    6377301.243, 300.8017 },       // EC (09) Everest(India1956)                
    { "Everest (Malaysia 1969)", 6377295.664, 300.8017 },       // ED (10) Everest(WMalaysia1969)            
    { "Everest (Malay & Sing)",  6377304.063, 300.8017 },       // EE (11) Everest(WMalaysia&Singapore1948)  
    { "Everest (Pakistan)",      6377309.613, 300.8017 },       // EF (12) Everest(Pakistan)                 
    { "Modified Fischer 1960",   6378155.000, 298.3 },          // FA (13) ModifiedFischer1960               
    { "Helmert 1906",            6378200.000, 298.3 },          // HE (14) Helmert1906                       
    { "Hough 1960",              6378270.000, 297.0 },          // HO (15) Hough1960                         
    { "Indonesian 1974",         6378160.000, 298.247 },        // ID (16) Indonesian1974                    
    { "International 1924",      6378388.000, 297.0 },          // IN (17) International_1924                
    { "Krassovsky 1940",         6378245.000, 298.3 },          // KA (18) Krassovsky1940                    
    { "GRS67",                   6378160.000, 6356774.516 },    
    { "GRS75",                   6378140.000, 6356755.288 },    
    { "GRS80",                   6378137.000, 298.257222101 },  // RF (21) GeodeticReferenceSystem1980(GRS80)
    { "S. American 1969",        6378160.000, 298.25 },         // SA (22) SouthAmerican 1969                
    { "WGS60",                   6378165.000, 298.3 },
    { "WGS66",                   6378145.000, 298.25 },
    { "WGS72",                   6378135.000, 298.26 },         // WD (25) WGS72                             
    { "WGS84",                   6378137.000, 298.257223563 }   // WE (26) WGS84                             
