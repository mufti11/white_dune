...
# creates a .deb (dpkg) installable binary package for debian wheezy
...
cp control_wheezy /tmp/$VERSION_DEBIAN/debian/control
cp rules_wheezy /tmp/$VERSION_DEBIAN/debian/rules
...
DATE=`date -R`
echo ' -- J. "MUFTI" Scheurich <mufti@zentux.rus.uni-stuttgart.de>  '$DATE >> /tmp/$VERSION_DEBIAN/debian/changelog
