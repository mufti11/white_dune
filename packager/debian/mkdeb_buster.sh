...
# creates a .deb (dpkg) installable binary package for debian buster
...
cp control_buster /tmp/$VERSION_DEBIAN/debian/control
cp rules_buster /tmp/$VERSION_DEBIAN/debian/rules
