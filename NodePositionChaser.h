...
#ifndef _NODE_POSITION_CHASER_H
...
class ProtoPositionChaser : public Proto {
public:
...
class NodePositionChaser : public Node {
public:
    ...
    fieldMacros(SFTime,  duration,           ProtoPositionChaser);
